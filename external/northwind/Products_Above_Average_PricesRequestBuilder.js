...
class Products_Above_Average_PricesRequestBuilder extends odata_v2_1.RequestBuilder {
    ...
    delete(productNameOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, productNameOrEntity instanceof Products_Above_Average_Prices_1.Products_Above_Average_Prices
            ? productNameOrEntity
