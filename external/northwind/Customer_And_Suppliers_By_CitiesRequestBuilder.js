...
class Customer_And_Suppliers_By_CitiesRequestBuilder extends odata_v2_1.RequestBuilder {
    ...
    delete(companyNameOrEntity, relationship) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, companyNameOrEntity instanceof Customer_And_Suppliers_By_Cities_1.Customer_And_Suppliers_By_Cities
            ? companyNameOrEntity
            : {
